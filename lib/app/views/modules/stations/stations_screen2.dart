...
import 'package:almuandes_billing_system/core/services/location_services.dart';
...
class StationsScreen2 extends StatelessWidget {
  StationsScreen2({super.key});
  ...
  Widget build(BuildContext context) {
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
        ...
        systemNavigationBarIconBrightness:
            ThemeService.to.isDark ? Brightness.dark : Brightness.light,
        systemNavigationBarColor: Get.theme.colorScheme.surface));
    return SuperScaffold(
      onWillPop: controller.onWillPop,
      showBackBtn: true,
      backBtnBgColor: Colors.black54,
      backBtnIconColor: Colors.white,
      backBtnPadding: 8,
      body: Obx(() {
        return SlidingBox(
