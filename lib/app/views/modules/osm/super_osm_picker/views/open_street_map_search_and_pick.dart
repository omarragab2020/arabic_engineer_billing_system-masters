        ...
        return SafeArea(
          child: Stack(
            children: [
              Positioned.fill(
                child: FlutterMap(
                  options: MapOptions(initialCenter: mapCentre!, initialZoom: 15.0, maxZoom: 18, minZoom: 6),
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () async {
                    if (mapCentre != null) {
                      _mapController.move(LatLng(mapCentre.latitude, mapCentre.longitude), _mapController.camera.zoom);
                    } else {
