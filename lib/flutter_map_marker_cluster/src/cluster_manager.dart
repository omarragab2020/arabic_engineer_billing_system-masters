  ...
  void addLayer(MarkerNode marker, int disableClusteringAtZoom, int maxZoom, int minZoom) {
    for (var zoom = maxZoom; zoom >= minZoom; zoom--) {
      ...
      if (zoom <= disableClusteringAtZoom) {
        ...
        if (cluster != null) {
          cluster.addChild(marker as MarkerOrClusterNode, marker.point);
          return;
        }
        ...
        if (closest != null) {
          ...
          final newCluster = MarkerClusterNode(
            ...
            ..addChild(closest as MarkerOrClusterNode, closest.point)
            ..addChild(marker as MarkerOrClusterNode, closest.point);
          ...
          parent.addChild(lastParent as MarkerOrClusterNode, lastParent.bounds.center);
    ...
    _topClusterLevel.addChild(marker as MarkerOrClusterNode, marker.point);
  }
